...
public class CheckUser_Saved_Albums extends BaseTest{
	...
	public void album(String SINO, String id,String albumids,String savedAlbums,String queryparamkey,String pathParam ) {
		...
		ApiActionUtil.getMethodWithQueryParam(query_Param_Map, Endpoints.CheckUsersavedAlbums,prop_constants.getProperty("status_code_200"), prop_constants.getProperty("content_type_json"));
