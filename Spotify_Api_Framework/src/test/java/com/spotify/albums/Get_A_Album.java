...
public class Get_A_Album extends BaseTest {
	...
	public void album(String SINO, String id,String albumids,String savedAlbums,String queryparamkey,String pathParam ) {
		...
		Response response = ApiActionUtil.getMethodWithPathParam(path_Param_Map, Endpoints.Album,
...
//		Assert.assertEquals(prop_constants.getProperty("artistname"), actualName,"List is created with given name");
	}
