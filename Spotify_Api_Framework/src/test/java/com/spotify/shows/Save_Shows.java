...
public class Save_Shows extends BaseTest{
	...
	public void shows(String SINO, String ids,String shows,String id ) {

		HashMap<String, String> query_Param_Map = new HashMap<String, String>();
		query_Param_Map.put("ids", shows);
		
		ApiActionUtil.putMethodWithQueryParamWithoutContet(query_Param_Map, Endpoints.SavedShow, prop_constants.getProperty("status_code_200"));
